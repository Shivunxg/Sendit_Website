        ...
        >
          ...
          <div className="prose prose-brand max-w-none">
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-4 text-brand-dark">1. Agreement to Terms</h2>
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-4 text-brand-dark">2. Services</h2>
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-4 text-brand-dark">4. Shipping and Logistics</h2>
              <p className="text-brand-accent/60 leading-relaxed mb-4">
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-4 text-brand-dark">5. Payments and Billing</h2>
              <p className="text-brand-accent/60 leading-relaxed">
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-4 text-brand-dark">6. Intellectual Property</h2>
              <p className="text-brand-accent/60 leading-relaxed">
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-4 text-brand-dark">8. Governing Law</h2>
              <p className="text-brand-accent/60 leading-relaxed">
